...
tempDSSID=$(curl -ks -H "Content-Type: application/json" -X POST "https://${dsmurl}/rest/authentication/login/primary" -d '{"dsCredentials":{"tenantName":"'${tenantName}'","userName":"'${username}'","password":"'${password}'"}}')
#echo -e "\n#### SID:"
#echo $tempDSSID
